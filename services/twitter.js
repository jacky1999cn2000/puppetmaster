...
module.exports = {
  ...
  login: async (page, browser, config) => {
    ...
    await page.waitFor(500);
    await page.type('#page-container > div > div.signin-wrapper > form > fieldset > div:nth-child(2) > input', config['twitter_username' + config.twitter_whichuser]);
    await page.type('#page-container > div > div.signin-wrapper > form > fieldset > div:nth-child(3) > input', config['twitter_password' + config.twitter_whichuser]);
